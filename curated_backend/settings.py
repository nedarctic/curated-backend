"""
Django settings for curated_backend project.
...
SECRET_KEY = 'django-insecure-5($75w3dd=%5f!s!87wrydlc+%w@9$zgzo*a2r&4kfd51hnk)*'
...
ROOT_URLCONF = 'curated_backend.urls'
...
WSGI_APPLICATION = 'curated_backend.wsgi.application'
